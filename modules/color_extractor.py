...
def color_extraction(filename, k):
    img = cv2.imread(f'./static/uploads/{filename}') #BGR
...
if __name__ == "__main__":
    ...
    print("img.shape:", img.shape) #(4000, 6000, 3)
    ...
    print("X.shape:", X.shape) # son 24M pixel, es mucho. Le voy a cambiar el tamaño a la imagen
    ...
    print("centroids:", centroids) # matriz de 3 columnas (R, G, B) y 4 filas (porque elegimos k = 4, 4 colores dominantes)
    #                   R           G           B
